...
for i, ax in enumerate(axes.flat):
        ...
        ax.text(0.02, 0.02, date_text[i],transform=ax.transAxes,ha="left",va="bottom",fontsize=14,color="white",
...
plt.savefig(f'/home/waynedj/Projects/swath_based_framework/figures/publication/Figure02_v001.png', dpi=500, bbox_inches='tight')
plt.show()
plt.close(fig)
